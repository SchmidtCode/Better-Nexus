    ...
    modules = {
        ...
        },
        {
            ...
            symbols=Symbols("A", {
                ...
                "GetLoadoutWishlistSlot", "JournalAssociationReadModel",
                ...
                "DisabledLevers", "ToggleLever", "AuthorityUnresolved",
                "InFlight", "Take", "Banish",
                ...
                "PresentationRevisions", "JournalAssociationRevisions",
